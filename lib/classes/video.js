...
class Video {
    ...
    encode() {
        ...
        return new Promise(function(resolve, reject) {
            ...
            // JMD fix ffmpeg "Too many packets buffered for output stream" https://stackoverflow.com/questions/49686244/ffmpeg-too-many-packets-buffered-for-output-stream-01
            _self.ffmpegCommand.outputOptions('-max_muxing_queue_size', 9999);
