    ...
    setASPreset() {
        ...
        return new Promise(function(resolve, reject) {
            ...
            switch (_self.options.asPreset) {
                case 'anime':
                    _self._addX265Option('weightb');
                    _self.options.preset = 'medium';
                    _self.ffmpegCommand.videoFilters('deband=r=32:1thr=0.01:2thr=0.01:3thr=0.01:4thr=0.01');
                    _self.options.bitdepth = 10;
                    break;
            ...
            function normalize() {
                ...
                if (_self.options.normalizeLevel >= 5) {
                    ...
                    if (!availableFilters.dynaudnorm) {
                        return reject(new Error('Installed ffmpeg version does not support the dynaudnorm audio filte.'));
                    }
