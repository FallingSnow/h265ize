    ...
    return yargs
        ...
        .options({
            ...
            'max-muxing-queue-size': {
                default: userSettings['max-muxing-queue-size'] || 0,
                describe: 'When transcoding audio and/or video streams, ffmpeg will not begin writing into the output until it has one packet for each such stream. While waiting for that to happen, packets for other streams are buffered. This option sets the size of this buffer, in packets, for the matching output stream. Set to 0 to use ffmpeg\'s default value.',
                type: 'number',
                group: 'Video:'
            },
            'he-audio': {
